package com.example.btl_android.DBHelper;
...
public class MyDBHelper extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        db.execSQL("insert into tb_san_pham values (7,2,'Bắp cải',15000,'img_bap_cai_trang_chu','Rau bắp cải là một loại rau có giá trị dinh dưỡng cao, chứa nhiều chất dinh dưỡng, bao gồm:\n" +
                "\n" +
                "Vitamin C: Có tác dụng tăng cường hệ miễn dịch, chống oxy hóa.\n" +
                "Vitamin K: Có tác dụng đông máu, giúp ngăn ngừa chảy máu.\n" +
                "Sắt: Có tác dụng tạo máu, giúp phòng ngừa thiếu máu.\n" +
        ...
        db.execSQL("insert into tb_san_pham values (11,2,'Củ đậu',13000,'img_cu_dau','Củ đậu hay còn gọi là sắn nước, có vị ngọt, mát, thường ăn sống hoặc ép lấy nước. Củ này giúp thanh nhiệt, giải độc, tốt cho hệ tiêu hóa.',14,'Nguyễn Anh','Củ')");
        db.execSQL("insert into tb_san_pham values (12,2,'Củ nghệ',22000,'img_cu_nghe','Củ nghệ là loại gia vị phổ biến có màu vàng cam, có tính kháng viêm, chống oxy hóa mạnh. Được dùng trong các món kho, xào và là vị thuốc dân gian trong chữa viêm loét dạ dày.',6,'Nguyễn Anh','Củ')");
